...
COPY services/web-gateway-service .
...
COPY --from=health-check-builder /home/packages/health-check ./health-check
WORKDIR /home/service/web-gateway-service
COPY --from=builder /home/service/web-gateway-service/build ./build
COPY services/web-gateway-service/package.json services/web-gateway-service/yarn.lock ./
