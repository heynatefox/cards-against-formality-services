...
COPY --from=health-check-builder /home/packages/health-check ./health-check
WORKDIR /home/service/clients-service
COPY --from=builder /home/service/clients-service/build ./build
COPY services/clients-service/package.json services/clients-service/yarn.lock ./
