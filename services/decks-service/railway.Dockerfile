...
COPY --from=health-check-builder /home/packages/health-check ./health-check
WORKDIR /home/service/decks-service
COPY --from=builder /home/service/decks-service/build ./build
COPY services/decks-service/package.json services/decks-service/yarn.lock ./
