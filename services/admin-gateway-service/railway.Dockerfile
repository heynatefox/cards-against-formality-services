...
COPY services/admin-gateway-service .
...
COPY --from=health-check-builder /home/packages/health-check ./health-check
WORKDIR /home/service/admin-gateway-service
COPY --from=builder /home/service/admin-gateway-service/build ./build
COPY services/admin-gateway-service/package.json services/admin-gateway-service/yarn.lock ./
